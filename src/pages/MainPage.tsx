              ...
              <Card size="small" style={{ marginBottom: 6 }}>
                <Space size={8}>
                  ...
                  <Button
                    ...
                    style={{
                      background: allPhasesDone ? '#52c41a' : undefined,
                      borderColor: allPhasesDone ? '#52c41a' : undefined,
                    }}
                  >
                    打开结果
                  </Button>
